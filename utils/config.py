...
class Config:
    ...
    # Dataset name
    dataset = ''
    #training_data_name = '/root/data/data/mesh/quadrilateral/train/point1024candidate12.h5'
    testing_data_name = ''
    data_dir = '/user38/data/mesh/quadrilateral/20240610/' #'/user38/data/mesh/quadrilateral/2022'20240530/
    phase = 'train'
    ...
    # Dimension of face input features
    in_face_features_dim = 12
    out_face_features_dim = 256
    ...
    # Dimension of the output feature maps
    output_features_dim = 64
    ...
    first_subsampling_dl = 0.01 # 0.02
