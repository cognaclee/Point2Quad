...
if __name__ == '__main__':
    input_dir='../pred_results/test_face_infos_29_w3.6_obj/pred/'
    ...
    print('0. watertightness=',watertightness/all_edges)
    print('1. manifoldness=',manifoldness/all_edges)

    print('2. q_aspect_ratio=',q_aspect_ratio/mesh_nums)
    print('3. q_cond=',q_cond/mesh_nums)
    print('4. q_edge_ratio=',q_edge_ratio/mesh_nums)
    print('5. q_jacobian=',q_jacobian/mesh_nums)
    print('6. q_ad=',q_ad/mesh_nums)
    print('7. q_maf=',q_maf/mesh_nums)
    print('8. q_meanaf=',q_meanaf/mesh_nums)
    print('9. q_max_a=',q_max_a/mesh_nums)
    print('10. q_min_a=',q_min_a/mesh_nums)
    print('11. q_max_edge_ratio=',q_max_edge_ratio/mesh_nums)
    print('12. q_oddy=',q_oddy/mesh_nums)
    print('13. q_radius_ratio=',q_radius_ratio/mesh_nums)
    print('14. qrs=',qrs/mesh_nums)
    print('15. shape=',shape/mesh_nums)
    print('16. shape_size=',shape_size/mesh_nums)
    print('17. shear=',shear/mesh_nums)
    print('18. shear_size=',shear_size/mesh_nums)
    print('19. skew=',skew/mesh_nums)
    print('20. stretch=',stretch/mesh_nums)
    print('21. taper=',taper/mesh_nums)
    print('22. warpage=',warpage/mesh_nums)
    print('23. q_s_jacobian=',q_s_jacobian/mesh_nums)
...
if __name__ == '__main__':
    ...
    output_dir='../hui/pred_obj/'
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
    start = len(input_dir)
    mesh_names = sorted(glob(input_dir+'/*.'+'m'))
    mesh_nums = len(mesh_names)
    for meshName in mesh_names:
        #print(meshName)
        vs, faces = read_m(meshName)
        baseName = meshName[start:-1]+'obj'
        filename = os.path.join(output_dir,baseName)
        write_obj(vs, faces, filename)
    """
    input_dir='../hui/pred_after_fillholes_obj/'#'../hui/pred_after_fillholes_obj/'
    #input_dir='/user38/data/mesh/quadrilateral/results_pc2tri2quad/'
    Metric = QuadMeshMetric()
