...
class PointCloudDataset(Dataset):
    ...
    def segmentation_inputs(self,
        ...
        print('input_neighbors.len=',len(input_neighbors))
        print('input_pools.len=',len(input_pools))
        print('input_upsamples.len=',len(input_upsamples))
        print('input_stack_lengths.len=',len(input_stack_lengths))
        print('stacked_features.len=',len(stacked_features))
